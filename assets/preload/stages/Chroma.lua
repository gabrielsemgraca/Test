...
makeLuaSprite('voidstrt', 'sans/start', -1000, -1000)
...
setProperty('Light.alpha', 0)
for _, crossSpriteRemove in ipairs({ 'BendyBG','BendyBG2','BendyGround'}) do
removeLuaSprite(crossSpriteRemove, true);
end
